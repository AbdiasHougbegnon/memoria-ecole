...
import { TuteurDeCoursMatieresPage } from './pages/TuteurDeCoursMatieresPage'
    ...
    <BrowserRouter>
      <div className="min-h-screen">
        <Routes>
          ...
          <Route path="/tuteur-de-cours" element={<RouteProtegee module="ECOLE"><TuteurDeCoursMatieresPage /></RouteProtegee>} />
